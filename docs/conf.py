...
devassistant_dir = os.path.abspath('..')
sys.path.insert(0, devassistant_dir)

from devassistant import __version__ as da_version
...
version = '.'.join(da_version.split('.')[0:2])
...
# documentation.
html_theme_options = {
    'relbarbgcolor': '#4B8299',
    'sidebarbgcolor': '#67B9DB',
    'codebgcolor': '#CBEEFC'
    }
